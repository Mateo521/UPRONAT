...
export class SwiperComponent  implements OnInit{
  ...
  slides: slide[] = [
    ...
    { imageUrl: baseUrl + 'img(6).jpeg', description: 'Análisis metabolómicos por RMN' , subtitle :'Podemos analizar la presencia de metabolitos especializados por distintas técnicas de Resonancia Magnética Nuclear.',route:'/capacidades-y-servicios/analisis-metabolicos-y-proteomicos'},
