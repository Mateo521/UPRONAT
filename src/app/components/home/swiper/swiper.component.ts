...
export class SwiperComponent {
  ...
  slides: slide[] = [
    ...
    { imageUrl: baseUrl + 'img(13).jpeg', description: 'Bioactivos para cosmética' , subtitle :'Extraemos, purificamos y caracterizamos bioactivos a partir de biomasa vegetal y microbiana. Recuperamos ingredientes a partir de subproductos agroalimenticios.',route:'/que-podemos-hacer/bioactivos-para-cosmetica'},
    { imageUrl: baseUrl + 'img(19).jpeg', description: 'Aditivos alimentarios  y nutraceúticos' , subtitle :'Extraemos, purificamos y caracterizamos compuestos con valor nutricional a partir de biomasa vegetal y microbiana. Recuperamos ingredientes y sustancias nutraceúticas a partir de subproductos agroalimenticios.',route:'/que-podemos-hacer/aditivos-alimentarios-y-nutraceuticos'},
    { imageUrl: baseUrl + 'img%20(3).jpeg', description: 'Análisis metabolómicos por RMN' , subtitle :'Podemos analizar la presencia de metabolitos especializados por distintas técnicas de Resonancia Magnética Nuclear.',route:'/que-podemos-hacer/analisis-metabolicos-y-proteomicos'},
    { imageUrl: baseUrl + 'img(18).jpeg', description: 'Bioactividad de sustancias puras y mezclas complejas' , subtitle :'Analizamos la bioactividad y toxicidad de sustancias puras y mezclas complejas    ',route:'/que-podemos-hacer/bioactividad-de-sustancias-puras-y-mezclas-complejas'},
