...
export class SwiperComponent  implements OnInit{
  ...
  slides: slide[] = [
    ...
    { imageUrl: baseUrl + 'img(6).jpeg', description: 'Análisis metabolómicos por RMN' , subtitle :'Podemos analizar la presencia de metabolitos especializados por distintas técnicas de Resonancia Magnética Nuclear.',route: '/'+this.generateLink('Análisis')},
    ...
    { imageUrl: baseUrl + 'img(25).jpg', description: 'Vinos' , subtitle :'Analizamos vinos mediante una tecnología única en Sudamérica <br> (<sup class="pl-1"> 1</sup> H-NMR Wine screening) que permite certificar variedad, denominación de origen, terroir, fraude o alteraciones e inscribirlos en una base de datos mundial. <br>  Estamos trabajando para incorporar por primera vez al Malbec argentino a la base de datos mundial de vinos por RMN.   ',route: '/'+this.generateLink('Vinos')},
